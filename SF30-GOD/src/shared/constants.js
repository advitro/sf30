// Shift Grabber V9 — Shared Constants
...
(function (global) {
  ...
  global.SG_CONSTS = {
    ...
    TIMING: {
      ...
      HUD_REFRESH_MS:             250,
      DOM_SCAN_MS:                400,
      NOTIFY_DURATION_MS:         2000,
      POLL_INTERVAL_MS:           150,
      TURBO_POLL_INTERVAL_MS:     100,
      RATE_LIMIT_POLL_MS:         2000,
      RATE_LIMIT_DURATION_MS:     10000,
      POLL_JITTER_MS:             50,
      BASE_MS:                    1000,
      BURST_JITTER_MS:            50,
      BURST_COUNT:                5,
      BURST_ANCHOR_EARLY_MS:      200,
      TOKEN_CHECK_INTERVAL_MS:    60000,
      TOKEN_REFRESH_THRESHOLD_S:  60,
      CSRF_CACHE_TTL_MS:          15000,
      API_LOAD_TIMEOUT_MS:        500,
      API_LOAD_POLL_MS:           50,
      API_LOAD_MAX_TRIES:         30,
    ...
    // ── Debug / Production ──
    DEBUG: true,   // GOD MODE: always verbose
